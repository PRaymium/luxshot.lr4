    <header class="header">
        <div class="header-wrapper">
            <a href="http://luxshot.lr4/" class="logo-link">
            ...
            <?php else : ?>
                ...
                <div class="nav-burger-menu hidden" id="nav-burger">
                    <div class="burger-menu__line burger-menu__line1"></div>
                    <div class="burger-menu__line burger-menu__line2"></div>
                    <div class="burger-menu__line burger-menu__line3"></div>
                </div>
                <nav id="nav-menu" class="nav-menu hidden">
                    <div class="nav-menu__title hidden">Меню</div>
                    <ul class="nav-menu__list hidden">
                        <li class="nav-menu__list-li hidden">
                            <div href="#" class="nav-menu__list-item hidden welcome">Здравствуйте, <?= $_SESSION['user']['name'] ?></div>
                        </li>
                        <li class="nav-menu__list-li hidden">
                            <a href="logout.php" class="nav-menu__list-item hidden">Выйти</a>
                        </li>
                    </ul>
                </nav>
            <?php endif; ?>
